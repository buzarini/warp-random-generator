...
#generateButton1,#generateButton2,#generateButton3,#generateButton7 {
    background: linear-gradient(90deg, #eeac43, #f15874);
}
#generateButton5,#generateButton6,#generateButton4,#generateButton8,#generateButton9 {
    background: linear-gradient(90deg, #eeac43, #f15874);margin-bottom: 6px;
}
...
#close2 {
	...
	#neko {margin-top: -181px}
	#hiddify {grid-column: 2; margin-top: -120px;}
...
@media (max-width: 700px) {
    ...
    #neko {order: 2;margin-top: 0px}
	#hiddify {grid-column: 1; margin-top: 0px;}
}
